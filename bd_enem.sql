...
CREATE TABLE CONTEM(
	ID_PROVA NUMERIC(8)  NOT NULL,
	SEQUENCIAL_QUESTAO NUMERIC(7) NOT NULL,
	CONSTRAINT PK_CONTEM PRIMARY KEY (ID_PROVA, SEQUENCIAL_QUESTAO)	
);

ALTER TABLE CONTEM ADD CONSTRAINT FK_CONTEM_PROVA FOREIGN KEY(ID_PROVA) REFERENCES PROVA(ID_PROVA);
ALTER TABLE CONTEM ADD CONSTRAINT FK_CONTEM_QUESTAO FOREIGN KEY(SEQUENCIAL_QUESTAO) REFERENCES QUESTAO(SEQUENCIAL_QUESTAO);
-----------------------------------------------------------------------------------------------------------------
